...
class YouHaveToldUsNewViewSpec extends BaseSpec {
  ...
  "Rendering the you have told us page" should {
    ...
    lazy val view = youHaveToldUsNewView(youHaveToldUsItems, additionalQuestionItem, Map.empty, taxCodeExists = true, pensionContributionsExists = true, givenPensionPercentage = true, studentLoansDefined = true, postGradLoansDefined = false, pensionWarning = false, roundedMonthlySalary = "166",scottishDefined = false, scottishResidentCheck = false)
