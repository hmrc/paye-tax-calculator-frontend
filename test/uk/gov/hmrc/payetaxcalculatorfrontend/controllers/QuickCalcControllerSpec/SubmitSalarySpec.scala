...
//import uk.gov.hmrc.payetaxcalculatorfrontend.quickmodel.{Days, Hours, Salary}
...
//      val controller = new QuickCalcController(messages.messages, cacheEmpty)
//      val formSalary = Salary.salaryBaseForm.fill(Salary(9.999,"yearly"))
//      val action = await(csrfAddToken(controller.submitSalaryAmount()))
//
//      val result = action(request
//        .withFormUrlEncodedBody(formSalary.data.toSeq: _*)
...
//      val controller = new QuickCalcController(messages.messages, cacheEmpty)
//      val formSalary = Salary.salaryBaseForm.fill(Salary(-1,"yearly"))
//      val action = await(csrfAddToken(controller.submitSalaryAmount()))
//
//      val result = action(request
//        .withFormUrlEncodedBody(formSalary.data.toSeq: _*)
...
//      val controller = new QuickCalcController(messages.messages, cacheEmpty)
//      val formSalary = Salary.salaryBaseForm.fill(Salary(10000000.00,"yearly"))
//      val action = await(csrfAddToken(controller.submitSalaryAmount()))
//
//      val result = action(request
//        .withFormUrlEncodedBody(formSalary.data.toSeq: _*)
...
//      val controller = new QuickCalcController(messages.messages, cacheEmpty)
//      val formSalary = Salary.salaryInHoursForm.fill(Hours(0,1))
//      val action = await(csrfAddToken(controller.submitSalaryAmount()))
//
//      val result = action(request
//        .withFormUrlEncodedBody(formSalary.data.toSeq: _*)
...
//      val controller = new QuickCalcController(messages.messages, cacheEmpty)
//      val formSalary = Salary.salaryInDaysForm.fill(Days(0,1))
//      val action = await(csrfAddToken(controller.submitSalaryAmount()))
//
//      val result = action(request
//        .withFormUrlEncodedBody(formSalary.data.toSeq: _*)
...
//      val controller = new QuickCalcController(messages.messages, cacheEmpty)
//      val formSalary = Salary.salaryInDaysForm.fill(Days(1,-1))
//      val action = await(csrfAddToken(controller.submitSalaryAmount()))
//
//      val result = action(request
//        .withFormUrlEncodedBody(formSalary.data.toSeq: _*)
...
//      val controller = new QuickCalcController(messages.messages, cacheEmpty)
//      val formSalary = Salary.salaryInHoursForm.fill(Hours(1,-1))
//      val action = await(csrfAddToken(controller.submitSalaryAmount()))
//
//      val result = action(request
//        .withFormUrlEncodedBody(formSalary.data.toSeq: _*)
...
//      val formSalary = Salary.salaryBaseForm.fill(Salary(20000,"yearly"))
//      val action = await(csrfAddToken(controller.submitSalaryAmount()))
//
//      val result = action(request.withFormUrlEncodedBody(formSalary.data.toSeq:_*)
//        .withSession(SessionKeys.sessionId -> "test-salary"))
