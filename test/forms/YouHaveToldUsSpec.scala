...
class YouHaveToldUsSpec extends BaseSpec with AnyWordSpecLike {
  ...
  "Converting Salary to YouHaveToldUsItem" in {
    ...
    YouHaveToldUs(Salary(2, None, None, "a year", None)) mustBe YouHaveToldUsItem("£2 a year",
                                                                                  yearlyLabel,
                                                                                  salaryUrl,
                                                                                  idSuffix)
    ...
    YouHaveToldUs(Salary(1, None, None, "a week", None)) mustBe YouHaveToldUsItem("£1 a week",
                                                                                  weeklyLabel,
                                                                                  salaryUrl,
                                                                                  idSuffix)

    val dailyLabel = "a_day"
    YouHaveToldUs(Salary(1, None, None, "a day", None)) mustBe YouHaveToldUsItem("£1 a day",
                                                                                 dailyLabel,
                                                                                 salaryUrl,
                                                                                 idSuffix)

    val hourlyLabel = "an_hour"
    YouHaveToldUs(Salary(2, None, None, "an hour", None)) mustBe YouHaveToldUsItem("£2 an hour",
                                                                                   hourlyLabel,
                                                                                   salaryUrl,
                                                                                   idSuffix)
  }
